...
CREATE TABLE IF NOT EXISTS reserva_items (
  ...
  PRIMARY KEY (reserva_id, item_id),
  CONSTRAINT fk_resitem_res FOREIGN KEY (reserva_id) REFERENCES reservas(id) ON DELETE CASCADE,
  CONSTRAINT fk_resitem_item FOREIGN KEY (item_id) REFERENCES inventario_items(id) ON DELETE CASCADE
);
